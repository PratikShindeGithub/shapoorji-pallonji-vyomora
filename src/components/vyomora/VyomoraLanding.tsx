...
import type { UnitPlan } from "@/components/vyomora/site-plans";
import {
  AMENITIES,
  CONFIGS,
  HIGHLIGHTS,
...
export type LandingOptions = {
  ...
  plans?: UnitPlan[];
  /** Sidebar / hero lead form CTA label. */
  formCta?: string;
  /** Tagged with every submission from this page. */
  interestedVariant?: string;
  /** Visible page heading in the hero card. */
  heading?: string;
